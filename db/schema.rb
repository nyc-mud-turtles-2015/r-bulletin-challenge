...
ActiveRecord::Schema.define(version: 20151020123845) do
  ...
  add_index "likes", ["user_id", "message_id"], name: "index_likes_on_user_id_and_message_id", unique: true, using: :btree
